        ...
        $(function() {
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'created', name: 'created', className: 'table-date small' },
...
@section('content')
    ...
    @if(!$data->count())
        ...
        @include('core::layouts.components.kosong', [
            ...
            'judul' => 'Anda belum memiliki Album',
            'subjudul' => 'Minimal Anda harus memiliki 1 (satu) album untuk mengupload galeri.', 
